...
ScrollReveal().reveal('.home-container p, .about-container1 p, .about-txt p:nth-child(2), .services-txt,  .services-box div:nth-child(2), .success-stories-box, .become-expert-container p',{origin:'right'});
